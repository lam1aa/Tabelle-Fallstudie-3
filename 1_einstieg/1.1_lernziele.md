...
Diese Fallstudie fokussiert Dashboards, graphische Benutzer*innenoberflächen, als Werkzeuge zur Datenvisualisierung für den Public Sector (z. B. Kennzahlen). Im Kap. 5 [Dashboard - Einzelelemente](dash-build-intro) können Sie selbst ein Dashboard erstellen. Die Dashboard-Gestaltung setzt ein grundlegendes Verständnis der <a href="https://www.r-project.org" class="external-link" target="_blank">Programmiersprache R</a> voraus, sodass sich dieses Kapitel an interessierte bzw. erfahrene Personen richtet.
...
1. Sie können die Entwicklung einer Fragestellung und ihre Operationalisierung am Beispiel der Ausprägungen des Engagements von Bürger:innen erläutern.
